...
<div class="row g-3">
    <div class="col-lg-8">
        ...
        <?php foreach($posts as $post): ?> <?php if ($role == "Admin"):?> 
        <div class="card mb-3">
        ...
        <?php elseif ($role === "Officer"):?> <?php 
            ...
            </div><?php endif; ?> <?php endif; ?> <?php endforeach; ?>
...
<?php endif; ?>
    ...
    <div class="col-lg-4">
        <div class="card mb-3 mb-lg-0">
            ...
            <div class="card-body fs-10"> <?php shuffle($activities); ?> <?php
                    $count = 0;
                    ...
                    <div class="calendar text-center me-3"> <?php
                                    $start_date = strtotime($activity->start_date);
                ...
                </div> <?php endif; endforeach; ?> <?php if (!$hasUpcomingActivities): ?> <h5 class="mb-0">No Upcoming Activity</h5> <?php endif; ?> </div>
