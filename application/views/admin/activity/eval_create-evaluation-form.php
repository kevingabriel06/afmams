		...
		if (isValid) {
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					let status_evaluation = "";

					if (now < startDate) {
						status_evaluation = "Upcoming";
					} else if (now >= startDate && now <= endDate) {
						status_evaluation = "Ongoing";
					} else {
						status_evaluation = "Completed";
					}


					formData.append("status_evaluation", status_evaluation);
