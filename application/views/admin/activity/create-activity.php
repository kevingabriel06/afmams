        ...
        <div class="card-body bg-body-tertiary">
            <form id="activityCreate" class="row g-3 needs-validation dropzone dropzone-multiple p-0" data-dropzone="data-dropzone" enctype="multipart/form-data" novalidate>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control datetimepicker" id="date_end" type="text" placeholder="yyyy-mm-dd" name="date_end" required>
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control datetimepicker" id="registration-deadline" type="text" placeholder="yyyy-mm-dd" name="registration_deadline" pattern="\d{4}-\d{2}-\d{2}" aria-describedby="calendarHelp" data-options='{"dateFormat":"Y-m-d","disableMobile":true, "minDate": "today"}' />
                ...
                <div class="col-sm-6 mb-3" id="am_in_div">
                    ...
                    <div class="input-group">
                        <input class="form-control datetimepicker" id="am_in" type="text" placeholder="H:i" name="am_in" aria-describedby="timeHelp" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"h:i K","disableMobile":true}' />
                ...
                <div class="col-sm-6 mb-3" id="am_out_div">
                    ...
                    <div class="input-group">
                        <input class="form-control datetimepicker" id="am_out" type="text" placeholder="H:i" name="am_out" aria-describedby="timeHelp" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"h:i K","disableMobile":true}' />
                        <span class="input-group-text" id="time-icon" title="Pick a time"><i class="fas fa-clock"></i></span>
                ...
                <div class="col-sm-6 mb-3" id="pm_in_div">
                    ...
                    <div class="input-group">
                        <input class="form-control datetimepicker" id="pm_in" type="text" placeholder="H:i" name="pm_in" aria-describedby="timeHelp" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"h:i K","disableMobile":true}' />
                        <span class="input-group-text" id="time-icon" title="Pick a time"><i class="fas fa-clock"></i></span>
                ...
                <div class="col-sm-6 mb-3" id="pm_out_div">
                    ...
                    <div class="input-group">
                        <input class="form-control datetimepicker" id="pm_out" type="text" placeholder="H:i" name="pm_out" aria-describedby="timeHelp" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"h:i K","disableMobile":true}' />
                        <span class="input-group-text" id="time-icon" title="Pick a time"><i class="fas fa-clock"></i></span>
                ...
                <div class="row gx-2">
                    <div class="col-12 mb-3">
                        ...
                        <input class="form-control" id="fines" type="text" placeholder="₱ 00.00" name="fines" required pattern="^\₱\s?\d+(?:,\d{3})*(?:\.\d{2})?$" />
...
<script>
    // SCRIPT FOT THE FIELDS ACCEPTING NUMBERS ONLY
