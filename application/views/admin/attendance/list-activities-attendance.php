...
<div class="row gx-3">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" id="year-picker" class="form-control" value="<?= htmlspecialchars($active_academic_year) ?>" readonly>
						</div>
					</div>
	...
	<script>
		document.addEventListener("DOMContentLoaded", function() {
			// Set semester and academic year display
			const semester = "<?= isset($semester_ay) ? $semester_ay->semester : '' ?>";
			const academicYear = "<?= isset($semester_ay) ? $semester_ay->academic_year : '' ?>";
			$('#semester-display').val(semester);
			$('#academic-year-display').val(academicYear);

			// Apply filter by status only
