...
<!-- Right Side Panel with Welcome Message and Semester/AY -->
<div class="card bg-100 shadow-none border mb-3">
	<div class="d-flex justify-content-between align-items-center w-100">
		...
		<div class="d-flex align-items-center">
			...
			<div>
				<h6 class="text-primary fs-10 mb-1">
					Welcome <?= htmlspecialchars($users['first_name'] ?? 'User'); ?> to
				</h6>
				<h4 class="text-primary fw-bold mb-0">
					<?= $this->session->userdata('dept_name') ?: $this->session->userdata('org_name'); ?>
					<span class="text-info fw-medium">Account</span>
				</h4>
			</div>
		</div>

		<!-- Right Side: Academic Year & Semester -->
		<div class="text-end d-flex align-items-center">
			<div class="me-3 text-end">
				<h4 class="text-primary fw-bold mb-0">
					<span class="text-info fw-medium">A.Y.</span>
					<?= $semester_ay->academic_year ?? 'N/A'; ?>
				</h4>
				<h6 class="text-primary fs-10 mb-0">
					<?= $semester_ay->semester ?? 'N/A'; ?>
				</h6>
			</div>
