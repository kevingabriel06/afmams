                        ...
                        if (event.target.files && event.target.files[0]) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    fetch("<?= base_url('officer/profile/update-profile-pic') ?>", {
                                            method: "POST",
                                            body: formData
                                        })
                        ...
                        $('form').submit(function(e) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    $.ajax({
                                        url: "<?php echo base_url('officer/profile/update-profile'); ?>",
                                        method: "POST",
                                        data: formData,
                    ...
                    <script>
                        ...
                        function updatePassword() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    const url = '<?= site_url("officer/profile/update_password") ?>';
