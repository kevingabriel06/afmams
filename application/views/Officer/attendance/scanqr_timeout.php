                        ...
                        setInterval(checkTimeRange, 1000);
                            ...
                            <script>
                                ...
                                function performFineProcess(activity_id, timeslot_id) {
                                    ...
                                    fetch('<?php echo site_url('officer/activity/update-fine/time-out'); ?>', {
                                            method: 'POST',
                                            headers: {
                                                'Content-Type': 'application/json'
                                            },
                                ...
                                <tbody class="list">
                                    <?php foreach ($students as $student): ?>
                                        <tr>
                                            ...
                                            <td class="time-out"><?php
                                                                    echo !empty($student['time_out'])
                                                                        ? date('Y-m-d | h:i A', strtotime($student['time_out']))
                                                                        : 'No Data';
                                                                    ?></td>
                                        </tr>
                                    <?php endforeach; ?>
