                        ...
                        <div class="card-body">
                            ...
                            <!-- <script>
                                ...
                                function performFineProcess(activity_id, timeslot_id) {
                                    ...
                                    fetch('<?php echo site_url('officer/activity/update-fine/time-in'); ?>', {
                                            method: 'POST',
                                            headers: {
                                ...
                                function performFineProcess(activity_id, timeslot_id) {
                                    ...
                                    fetch('<?php echo site_url('officer/activity/update-fine/time-in'); ?>', {
                                        ...
                                        .then(data => {
                                            ...
                                            setTimeout(function() {
                                                window.location.href = '<?php echo site_url('officer/activity-details/'); ?>' + activity_id;
            ...
            <script>
                ...
                window.onload = function() {
                    ...
                    video.addEventListener("play", async () => {
                        ...
                        //         // ❗ Skip drawing if already scanned
                        //         if (detectedFacesSet.has(bestMatch.label)) return;
                        ...
                        //     detectedFaces = resizedDetections
                        //         .map((detection) => faceMatcher.findBestMatch(detection.descriptor).label)
                        //         .filter((label) => !detectedFacesSet.has(label)); // ✅ Only new, unscanned faces
                            ...
                            for (const detectedFace of detectedFaces) {
                                if (!detectedFacesSet.has(detectedFace)) {
                                    ...
                                    if (student) {
                                        ...
                                        const result = await fetch("<?= base_url('officer/attendance/detect_timein'); ?>", {
                                            method: 'POST',
                                            headers: {
                                                'Content-Type': 'application/json'
                                            },
                    ...
                    // // Mark attendance based on detected faces
                    // async function markAttendance(detectedFaces) {
                    //     try {
                ...
                scanner.addListener('scan', function(content) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('officer/attendance/detect_timein'); ?>",
                        method: "POST",
                        dataType: "json",
                        data: {
                            student_id: text,
