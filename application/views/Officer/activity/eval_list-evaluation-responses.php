...
<div class="row gx-3">
				...
				<div class="d-lg-flex justify-content-between">
					...
					<div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
						<div class="d-flex align-items-center" id="table-ticket-replace-element">
							...
							<a href="<?= base_url('OfficerController/export_evaluation_responses_pdf/' . $form_id); ?>" class="btn btn-sm btn-falcon-default ms-2">
	...
	<div class="d-flex justify-content-end mb-3">
		<a href="<?php echo site_url('officer/evaluation-statistic/' . $forms->form_id); ?>" class="btn btn-primary">
