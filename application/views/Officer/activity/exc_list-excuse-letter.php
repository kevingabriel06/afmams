				...
				<div class="d-lg-flex justify-content-between">
					...
					<div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
						<div class="d-flex align-items-center" id="table-ticket-replace-element">
							...
							<!-- Export Button -->
							<a class="btn btn-sm btn-falcon-default ms-2" href="<?php echo site_url('OfficerController/export_excuse_applications_pdf/' . $activities['activity_id']); ?>" target="_blank">
							...
							<?php foreach ($letters as $letter) : ?>
								<?php if ($letter->activity_id == $activities['activity_id']): ?>
									<tr class="letter-row" data-status="<?php echo $letter->status; ?>">
										...
										<td class="align-middle subject department text-nowrap">
											<?php echo $letter->dept_name; ?>
										</td>
										<td class="align-middle subject subject text-nowrap">
