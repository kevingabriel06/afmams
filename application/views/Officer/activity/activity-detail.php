										...
										<div class="d-lg-flex justify-content-between">
											...
											<div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
												<div class="d-flex align-items-center" id="table-ticket-replace-element">
													...
													<!-- Button -->
													<button class="btn btn-sm btn-falcon-default ms-2" type="button" onclick="document.getElementById('exportPdfForm').submit();">
									...
									<div class="d-flex flex-row gap-4 flex-wrap mt-2">
										...
										<div class="d-flex flex-column align-items-start gap-1">
											...
											<a href="#" class="btn btn-falcon-success btn-sm px-4 px-sm-7 scan-btn"
												data-url="<?= site_url('officer/activity/scan-qr/time-in/' . $schedule['activity_id'] . '/' . $schedule['timeslot_id']); ?>"
										...
										<div class="d-flex flex-column align-items-start gap-1">
											...
											<a href="#" class="btn btn-falcon-danger btn-sm px-4 px-sm-7 scan-btn"
												data-url="<?= site_url('officer/activity/scan-qr/time-out/' . $schedule['activity_id'] . '/' . $schedule['timeslot_id']); ?>"
...
<!-- Form for exporting the PDF -->
<form id="exportPdfForm" action="<?= base_url('OfficerController/export_registered_students_pdf') ?>" method="get" target="_blank" style="display: none;">
	<input type="hidden" name="activity_id" value="<?= $activity['activity_id'] ?>"> <!-- Include the activity_id -->
</form>