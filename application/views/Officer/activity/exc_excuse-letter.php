<div class="row g-3">
  <div class="col-xxl-9 col-xl-8">
    <div class="card">
      <div class="card-header d-flex flex-between-center"><a class="btn btn-falcon-default btn-sm" href="<?php echo site_url('officer/list-of-excuse-letter/' . $excuse['activity_id']); ?>">
...
<script>
  ...
  document.getElementById('approvalForm').addEventListener('submit', function(event) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: 'You are about to update the status of this excuse letter.',
      icon: 'question',
      ...
      if (result.isConfirmed) {
        ...
        fetch('<?php echo site_url('officer/review-excuse-letter/update'); ?>', {
            method: 'POST',
            body: formData
          })
