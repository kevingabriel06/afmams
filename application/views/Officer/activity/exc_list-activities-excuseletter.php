...
<div class="row gx-3">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Display Active Semester and Academic Year side by side as read-only -->
					<div class="row mb-3">
						<div class="col-md-6">
	...
	<script>
		window.applyFilters = function() {
			...
			let activities = document.querySelectorAll('.activity-row'); // Your rows
		...
		function toggleNoActivityMessage(showAny) {
			const message = document.getElementById('no-activity-message'); // adjust to your actual fallback id
			if (message) {
