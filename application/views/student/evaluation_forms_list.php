			...
			<div class="card-body p-0">
				<div class="table-responsive scrollbar">
						...
						<tbody class="list" id="table-ticket-body">
							<?php foreach ($forms as $form) : ?>
								<tr class="activity-row" data-start-date="<?php echo $form->start_date_evaluation; ?>" data-status="<?php echo $form->status_evaluation; ?>">
									...
									<td class="status">
										<?php if ($form->status_evaluation == 'Completed'): ?>
											<span class="badge rounded-pill badge-subtle-success">
												<?php echo $form->status_evaluation; ?> <span class="ms-1 fas fa-check"></span>
											</span>
										<?php elseif ($form->status_evaluation == 'Ongoing'): ?>
											<span class="badge rounded-pill badge-subtle-warning">
												<?php echo $form->status_evaluation; ?> <span class="ms-1 fas fa-hourglass-half"></span>
											</span>
										<?php else: ?>
											<span class="badge rounded-pill badge-subtle-danger">
												<?php echo $form->status_evaluation; ?> <span class="ms-1 fas fa-clock"></span>
											</span>
										<?php endif; ?>
									</td>
									<td class="remarks">
							...
							<tr id="no-activity-row" style="display: none;">
								<td colspan="4" class="text-center text-muted fs-8 fw-bold py-2 bg-light">
									...
									<h5 class="mt-2 mb-1">No evaluation form listed.</h5>
								</td>
							</tr>
						</tbody>
					</table>
					<div class="text-center d-none" id="tickets-table-fallback">
						<span class="fas fa-calendar-times fa-2x text-muted"></span> <!-- Calendar icon -->
						<p class="fw-bold fs-8 mt-3">No evaluation form found</p>
					</div>
				</div>
			</div>
