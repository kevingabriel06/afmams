					...
					<div class="avatar avatar-5xl avatar-profile shadow-sm img-thumbnail rounded-circle">
						<div class="h-100 w-100 rounded-circle overflow-hidden" style="width: 200px; height: 200px;">
							<img id="profile-preview" src="<?php
															$profilePic = !empty($student_details->profile_pic) ? $student_details->profile_pic : 'default.jpg';
															echo base_url('assets/profile/' . $profilePic);
															?>" alt="Profile Picture" />
					...
					fetch('<?php echo site_url("student/profile/get_qr_code_by_student"); ?>', {
						...
						.then(data => {
							...
							if (data.status === 'success' && data.qr_code) {
								...
								downloadLink.classList.add('btn', 'btn-primary', 'mt-3'); // Bootstrap styling
