...
<div class="col-12">
    ...
    <div class="card-header position-relative min-vh-25 mb-8">
		...
		<form id="profilePicForm" action="<?= base_url('student/update_profile_pic') ?>" method="POST" enctype="multipart/form-data">
...
document.getElementById('profile-image').addEventListener('change', function(event) {
    if (event.target.files && event.target.files[0]) {
        ...
        fetch("<?= base_url('student/update_profile_pic') ?>", {
            method: "POST",
            body: formData
        })
...
<div class="col-lg-8 pe-lg-2">
	...
	<!-- Your form -->
<form class="row g-3" action="<?php echo site_url('student/update-profile/'.$student_id); ?>" method="POST">
...
<div class="card mb-3">
    ...
    <div class="card-body bg-body-tertiary">
        <form method="POST" action="<?= site_url('student/change_password'); ?>">
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('form[action="<?php echo site_url('student/update-profile/'.$student_id); ?>"]').onsubmit = function (e) {
        e.preventDefault(); // Prevent form submission to show the confirmation dialog
        alertify.confirm(
            ...
            function () {
                ...
                setTimeout(function () {
                    document.querySelector('form[action="<?php echo site_url('student/update-profile/'.$student_id); ?>"]').submit();
